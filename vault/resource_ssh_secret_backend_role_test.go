...
//)
//
//func TestAccAWSAuthBackendRole_otp(t *testing.T) {
...
//		CheckDestroy: testAccCheckSSHSecretBackendRoleDestroy,
...
//}
//
//func testAccCheckSSHSecretBackendRoleDestroy(s *terraform.State) error {
...
//		if err != nil {
//			return fmt.Errorf("Error checking for SSH secret backend role %q: %s", rs.Primary.ID, err)
//		}
//		if secret != nil {
//			return fmt.Errorf("SSH secret backend role %q still exists", rs.Primary.ID)
//		}
//	}
//	return nil
//}
...
//}
//
//func testAccSSHSecretBackendRoleConfig_inferred(backend, role string) string {
//	return fmt.Sprintf(`
//resource "vault_secret_backend" "aws" {
//  type = "aws"
//  path = "%s"
//}
//
